...
<#function hasLocalDataTimeField columnList>
	<#list model.columnList as col>
		<#if col.colType == 'java.util.Date'>
			<#assign rtn>import java.time.LocalDateTime;</#assign><#return rtn>
		</#if>
	</#list>
	<#assign rtn></#assign><#return rtn>
</#function>

<#function getFieldType colType>
	<#if colType != 'java.util.Date'>
		<#assign rtn>${colType}</#assign><#return rtn>
	</#if>
	<#assign rtn>LocalDateTime</#assign><#return rtn>
</#function>
