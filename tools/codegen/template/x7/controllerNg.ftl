 ...
 */
@RestController
@RequestMapping(value="/${system}/${classVar}/v1")
@Api(tags="${classVar}Controller")
public class ${class}Controller extends BaseController<${class}Manager,${class}>{
	@Resource
	...
	public ${class} get(@ApiParam(name="${pkVar}",value="业务对象主键", required = true)@RequestParam ${pkType} ${pkVar}) throws Exception{
