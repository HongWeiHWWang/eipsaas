...
@XmlRootElement(name = "userRule", namespace = "http://www.jee-soft.cn/bpm/plugins/userCalc/base")
public class UserRule {
    ...
    @XmlElement(namespace = "http://www.jee-soft.cn/bpm/plugins/userCalc/base", required = true)
