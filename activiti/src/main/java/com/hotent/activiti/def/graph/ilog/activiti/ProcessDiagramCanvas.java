...
//		int wrapWidth =  g.getFontMetrics().stringWidth(name);
//		if(wrapWidth > 150){
//			wrapWidth = wrapWidth/2;
//		}
		
//		int wrapWidth = 110,wrapHeight=30;
//		String[] nameAry = fitTextToWidthAndBreak(name,wrapWidth+1);
	...
	static {
		try {
			USERTASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/hotent/bpmx/activiti/image/user.png"));
			SCRIPTTASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/hotent/bpmx/activiti/image/script.png"));
			SERVICETASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/hotent/bpmx/activiti/image/service.png"));
			RECEIVETASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/hotent/bpmx/activiti/image/receive.png"));
			SENDTASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/hotent/bpmx/activiti/image/send.png"));
			MANUALTASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/hotent/bpmx/activiti/image/manual.png"));
			TIMER_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/hotent/bpmx/activiti/image/timer.png"));
			ERROR_THROW_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/hotent/bpmx/activiti/image/error_throw.png"));
			ERROR_CATCH_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/hotent/bpmx/activiti/image/error_catch.png"));
			CALLACTIVITY_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/hotent/bpmx/activiti/image/call_activity.png"));
...
//			Color pool_backgroup_color_temp=new Color(211,215,212);//getColor("POOL_BACKGROUP_COLOR");
//			Color pool_boundary_color_temp=new Color(138,140,142);;//getColor("LANE_BOUNDARY_COLOR");
