 ...
 */
public class HtStartSubFlowTaskJsonConverter extends CallActivityJsonConverter implements HtStencilConstants{
  ...
  public static void fillJsonTypes(Map<String, Class<? extends BaseBpmnJsonConverter>> convertersToBpmnMap) {
    convertersToBpmnMap.put(STENCIL_TASK_STARTSUBTASK, HtStartSubFlowTaskJsonConverter.class);
  }
  ...
  protected String getStencilId(BaseElement baseElement) {
    return STENCIL_TASK_STARTSUBTASK;
  }
