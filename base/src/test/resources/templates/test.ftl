...
<#--调用-->
<@macroDemo.demo1 'red','${name}'/>

<@macroDemo.copyright '${dateRange}'/>
...
<div class="panel-page">		
	...
	<div class="l-bar-group-right">
		...
		<div class="l-bar-group">
			<span class="pcontrol"> 
				<input size="4" value="1" style="width: 20px;text-align:center" maxlength="3" class="inputText" type="text" id="navNum${tableIdCode}" name="navNum"/>/ <span>20</span>
			</span>
		</div>
		<div class="l-bar-separator"></div>
		<div class="l-bar-group">
